...
/*
* File:   usfm_Projection_Division1.hpp
* Author: Michal Polic, michal.polic(at)cvut.cz
*/

#ifndef USFM_PROJECTION_DIVISION1_H
#define USFM_PROJECTION_DIVISION1_H
...
namespace usfm {
	...
	class ProjectionDivision1 : public Projection {
	public:
		static const int N_CAM_PARAMS = 4;
		static const int N_IMG_PARAMS = 6;

		ProjectionDivision1();
		ProjectionDivision1(Camera* camera);
		ProjectionDivision1(Image* camera);
		ProjectionDivision1(Camera* camera, Image* image);
		ProjectionDivision1(Camera* camera, Image* image, Point3D* X, Point2D* obs);
...
#endif //USFM_PROJECTION_DIVISION1_H