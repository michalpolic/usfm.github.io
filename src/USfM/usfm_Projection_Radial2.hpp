...
/*
* File:   usfm_Projection_Radial2.hpp
* Author: Michal Polic, michal.polic(at)cvut.cz
*/

#ifndef USFM_PROJECTION_RADIAL2_H
#define USFM_PROJECTION_RADIAL2_H
...
namespace usfm {
	...
	class ProjectionRadial2 : public Projection {
	public:
		static const int N_CAM_PARAMS = 5;
		static const int N_IMG_PARAMS = 6;

		ProjectionRadial2();
		ProjectionRadial2(Camera* camera);
		ProjectionRadial2(Image* camera);
		ProjectionRadial2(Camera* camera, Image* image);
		ProjectionRadial2(Camera* camera, Image* image, Point3D* X, Point2D* obs);
