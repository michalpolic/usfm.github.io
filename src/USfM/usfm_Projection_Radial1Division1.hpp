...
/*
* File:   usfm_Projection_Radial1Division1.hpp
* Author: Michal Polic, michal.polic(at)cvut.cz
*/

#ifndef USFM_PROJECTION_RADIAL1DIVISION1_H
#define USFM_PROJECTION_RADIAL1DIVISION1_H
...
namespace usfm {
	...
	class ProjectionRadial1Division1 : public ProjectionACC {
	public:
		static const int N_CAM_PARAMS = 5;
		
		ProjectionRadial1Division1();
		ProjectionRadial1Division1(Camera* camera);
		ProjectionRadial1Division1(Image* camera);
		ProjectionRadial1Division1(Camera* camera, Image* image);
		ProjectionRadial1Division1(Camera* camera, Image* image, Point3D* X, Point2D* obs);
		...
		bool operator()(const T* const X, const T* const cam, const T* const img, T* residuals) const 
		{
			...
			const T r2 = x*x + y*y;
			const T distortion = (T(1.0) + k[0] * r2) / (T(1.0) + k[1] * r2);
...
#endif //USFM_PROJECTION_RADIAL1DIVISION1_H