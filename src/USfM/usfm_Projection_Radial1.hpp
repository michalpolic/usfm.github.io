...
/*
* File:   usfm_Projection_Radial1.hpp
* Author: Michal Polic, michal.polic(at)cvut.cz
*/

#ifndef USFM_PROJECTION_RADIAL1_H
#define USFM_PROJECTION_RADIAL1_H
...
namespace usfm {
	...
	class ProjectionRadial1 : public Projection {
	public:
		static const int N_CAM_PARAMS = 4;
		static const int N_IMG_PARAMS = 6;

		ProjectionRadial1();
		ProjectionRadial1(Camera* camera);
		ProjectionRadial1(Image* camera);
		ProjectionRadial1(Camera* camera, Image* image);
		ProjectionRadial1(Camera* camera, Image* image, Point3D* X, Point2D* obs);
...
#endif //USFM_PROJECTION_SIMPLE_RADIAL_H