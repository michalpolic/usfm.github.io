...
/*
* File:   usfm_Projection_Radial2Division2.hpp
* Author: Michal Polic, michal.polic(at)cvut.cz
*/

#ifndef USFM_PROJECTION_RADIAL2DIVISION2_H
#define USFM_PROJECTION_RADIAL2DIVISION2_H
...
namespace usfm {
	...
	class ProjectionRadial2Division2 : public ProjectionACC {
	public:
		static const int N_CAM_PARAMS = 7;

		ProjectionRadial2Division2();
		ProjectionRadial2Division2(Camera* camera);
		ProjectionRadial2Division2(Image* camera);
		ProjectionRadial2Division2(Camera* camera, Image* image);
		ProjectionRadial2Division2(Camera* camera, Image* image, Point3D* X, Point2D* obs);
		...
		bool operator()(const T* const X, const T* const cam, const T* const img, T* residuals) const
		{
			...
			const T r2 = x * x + y * y;
			const T r4 = r2 * r2;
			const T distortion = (T(1.0) + k[0] * r2 + k[1] * r4) / (T(1.0) + k[2] * r2 + k[3] * r4);
...
#endif //USFM_PROJECTION_RADIAL2DIVISION2_H